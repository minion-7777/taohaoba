 ...
 */
public class DynamicHeightViewPager2 extends ViewPager {
    ...
    public DynamicHeightViewPager2(Context context) {
        super(context);
    }

    public DynamicHeightViewPager2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
