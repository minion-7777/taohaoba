...
import io.openim.android.taohaoba.ui.fragment.MyBuyOrderListFragment;
 ...
 *  我买的订单列表
 */
public class MyBuyOrderListActivity extends BaseActivity<MyBuyOrderVM, ActivityMyBuyOrderListBinding> implements MyBuyOrderVM.ViewAction {
...
//        view.rcRecycler.setLayoutManager(new LinearLayoutManager(getBaseContext(), HORIZONTAL, false));
        ...
        for (int i = 0; i < list.size(); i++) {
            MyBuyOrderListFragment fragment = MyBuyOrderListFragment.newInstance(i);
            fragment.setPage(i);
