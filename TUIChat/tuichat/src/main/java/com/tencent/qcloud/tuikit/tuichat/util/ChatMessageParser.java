...
public class ChatMessageParser {
    ...
    private static TUIMessageBean parseCustomMessage(V2TIMMessage v2TIMMessage) {
        String im_seller_idViewHolder = MMKV.defaultMMKV().decodeString("im_seller_id", "");
        String im_buyer_idViewHolder = MMKV.defaultMMKV().decodeString("im_buyer_id", "");
        String im_owner_idViewHolder = MMKV.defaultMMKV().decodeString("im_owner_id", "");
        ...
        int intelligentType = jsonObject.getIntValue("intelligentType");
        if (intelligentType == 1) {
            IntelligentTipsMessageABean bean = new IntelligentTipsMessageABean();
            bean.setIntelligentData(dataStr);
            return bean;
        }else if (intelligentType == 2) {
            IntelligentTipsMessageBBean bean = new IntelligentTipsMessageBBean();
            bean.setIntelligentData(dataStr);
            return bean;
        }else if (intelligentType == 3) {
            IntelligentTipsMessageCBean bean = new IntelligentTipsMessageCBean();
            bean.setIntelligentData(dataStr, im_buyer_idViewHolder);
            return bean;
        }else if (intelligentType == 5) {
            IntelligentTipsMessageEBean bean = new IntelligentTipsMessageEBean();
            bean.setIntelligentData(dataStr, im_seller_idViewHolder, im_buyer_idViewHolder, im_owner_idViewHolder);
            return bean;
        }else if (intelligentType == 8) {
            IntelligentTipsMessageHBean bean = new IntelligentTipsMessageHBean();
            bean.setIntelligentData(dataStr);
            return bean;
        }else if (intelligentType == 9) {
            IntelligentTipsMessageIBean bean = new IntelligentTipsMessageIBean();
            bean.setIntelligentData(dataStr, im_buyer_idViewHolder);
            return bean;
        }else if (intelligentType == 10) {
            IntelligentTipsMessageJBean bean = new IntelligentTipsMessageJBean();
            bean.setIntelligentData(dataStr);
            return bean;
        }
    ...
    public static String getReplyMessageAbstract(TUIMessageBean messageBean) {
        ...
        if (messageBean != null) {
            ...
            if (messageBean instanceof TextMessageBean) {
                ...
                extra = "";
            } else if (messageBean instanceof IntelligentTipsMessageABean) {
                IntelligentTipsMessageABean tipsBean = (IntelligentTipsMessageABean) messageBean;
                extra = "["+tipsBean.getTitle()+"]";
            } else if (messageBean instanceof IntelligentTipsMessageBBean) {
                IntelligentTipsMessageBBean tipsBean = (IntelligentTipsMessageBBean) messageBean;
                extra = "["+tipsBean.getTitle()+"]";
            } else if (messageBean instanceof IntelligentTipsMessageCBean) {
                IntelligentTipsMessageCBean tipsBean = (IntelligentTipsMessageCBean) messageBean;
                extra = "["+tipsBean.getTitle()+"]";
            } else if (messageBean instanceof IntelligentTipsMessageEBean) {
                IntelligentTipsMessageEBean tipsBean = (IntelligentTipsMessageEBean) messageBean;
                extra = "["+tipsBean.getTitle().getText()+"]";
            } else if (messageBean instanceof IntelligentTipsMessageHBean) {
                IntelligentTipsMessageHBean tipsBean = (IntelligentTipsMessageHBean) messageBean;
                extra = "["+tipsBean.getTitle()+"]";
            } else if (messageBean instanceof IntelligentTipsMessageIBean) {
                IntelligentTipsMessageIBean tipsBean = (IntelligentTipsMessageIBean) messageBean;
                extra = "["+tipsBean.getTitle()+"]";
            } else if (messageBean instanceof IntelligentTipsMessageJBean) {
                IntelligentTipsMessageJBean tipsBean = (IntelligentTipsMessageJBean) messageBean;
                extra = "["+tipsBean.getTitle()+"]";
            }else {
