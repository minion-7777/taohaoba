...
//        final ChatPopMenu.ChatPopMenuAction replyAction = createReplyAction(msg, textIsAllSelected);
        ...
        addActionIfEnabled(multiSelectAction, TUIChatConfigClassic.isEnableSelect() && getChatInfo().isPopMenuEnableMultiSelect() && !msg.hasRiskContent(), 8000);
...
//        addDefaultMessageActions(msg, copyAction, forwardAction);
        addDefaultMessageActions(msg, copyAction);
    ...
    private void addDefaultMessageActions(TUIMessageBean msg, ChatPopMenu.ChatPopMenuAction copyAction) {
