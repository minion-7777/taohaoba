...
public class TUIChatService implements TUIInitializer, ITUIService, ITUINotification {
    ...
    public void init(Context context) {
        ...
        allowBeep = MMKV.defaultMMKV().decodeBool("allowBeep",  true);
        allowVibration = MMKV.defaultMMKV().decodeBool("allowVibration",  true);
        initMessageType();
        initService();
        initEvent();
        initIMListener();
    ...
    private void initIMListener() {
        V2TIMManager.getMessageManager().addAdvancedMsgListener(new V2TIMAdvancedMsgListener() {
            ...
            public void onRecvNewMessage(V2TIMMessage msg) {
                if (allowBeep){
                    Constants.playPrompt();
                }

                if (allowVibration){
                    Constants.vibrate(200);
                }
