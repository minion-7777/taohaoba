...
public class ChatPopMenu {
    // action column num
    private static final int ACTION_COLUMN_NUM = 4;

    // shadow width
    private static final int SHADOW_WIDTH = 10;
    // rect radius
    private static final int RECT_RADIUS = 30;
    ...
    class PopIndicatorDrawable extends Drawable {
        ...
        public PopIndicatorDrawable(View anchorView, int indicatorHeight, float radius) {
            ...
            paint.setColor(0xFFEADAC1);
            paint.setStyle(Paint.Style.FILL);
            paint.setShadowLayer(SHADOW_WIDTH, 0, 0, 0xFF413D38);
        }
