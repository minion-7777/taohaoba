...
public class ConversationPresenter {
    ...
    public void loadMoreConversation() {
        loadMoreConversation(0, 1);
    }
    public void loadMoreConversation(int type, int page) {
        if (page == 0) {
            loadedConversationInfoList.clear();
        }
        provider.loadMoreConversation(type, page, GET_CONVERSATION_COUNT, new IUIKitCallback<List<ConversationInfo>>() {
            @Override
    ...
    public static String getMessageDisplayString(TUIMessageBean messageBean) {
        ...
        if (messageBean.getStatus() == TUIMessageBean.MSG_STATUS_REVOKE) {
            ...
            if (messageBean instanceof IntelligentTipsMessageABean) {
                IntelligentTipsMessageABean tipsBean = (IntelligentTipsMessageABean) messageBean;
                displayString = "["+tipsBean.getTitle()+"]";
                ...
                displayString = "["+tipsBean.getTitle().getText()+"]";
